      ...
      <div className="mx-auto flex min-h-[76px] w-[min(1120px,calc(100%-2rem))] flex-col gap-3 py-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <button
            ...
            className="relative grid h-8 w-8 place-items-center rounded-xl border border-admin-border bg-white/2 text-admin-text-secondary transition hover:bg-admin-hover hover:text-admin-text-primary"
