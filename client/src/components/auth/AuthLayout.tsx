  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full blur-3xl opacity-70 animate-pulse" style={{animationDelay: "1s"}} />
      ...
      <div className="relative z-10 min-h-screen w-full flex items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          ...
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-white/5 to-white/5 backdrop-blur-xl border border-white/10" style={{filter: "drop-shadow(0 8px 32px rgba(31, 41, 55, 0.1))"}} />
