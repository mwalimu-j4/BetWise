  ...
  return (
    <section className="grid gap-4">
        ...
        <div className="grid gap-3 lg:grid-cols-[1.6fr_1fr_1fr]">
          <div className="relative">
            ...
            <Input
              ...
              className="h-10 rounded-xl border border-admin-border bg-[var(--color-bg-elevated)] pl-9 text-admin-text-primary placeholder:text-admin-text-muted focus:border-[var(--color-border-focus)] focus:shadow-[0_0_0_3px_var(--color-accent-soft)] focus:outline-none transition"
            />
          </div>
          ...
          >
            <SelectTrigger className="h-10 w-full rounded-xl border border-admin-border bg-[var(--color-bg-elevated)] text-admin-text-primary font-medium hover:border-[var(--color-border-focus)] focus:border-[var(--color-border-focus)] focus:shadow-[0_0_0_3px_var(--color-accent-soft)] focus:outline-none transition">
              <SelectValue
                placeholder="All types"
                className="text-admin-text-primary"
              />
            </SelectTrigger>
            <SelectContent className="border-admin-border bg-[var(--color-bg-deepest)] text-admin-text-primary">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <article className="rounded-2xl border border-admin-border bg-[var(--color-bg-elevated)] p-3">
